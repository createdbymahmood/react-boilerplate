...
import { AppLayout, IndexLayout } from '@components';
    ...
    return (
        <IndexLayout>
            <div className='relative min-h-screen bg-gray-100'>
                <main className='px-4 lg:px-0 pb-10 '>
                    {/* Page header */}
                    <div className='mx-auto md:flex md:items-center md:justify-between w-full'>
                    ...
                    <div className='mt-8 mx-auto grid grid-cols-1 gap-6 lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-3 '>
                        ...
                        <div>
                            <section
                                ...
                                className='lg:col-start-3 lg:col-span-1 sticky top-4 divide-y '
                            >
